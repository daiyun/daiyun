...
public class DruidConfiguration {
    ...
    public DruidDataSource dataSource() {
        ...
        try {
            ...
            logger.error("daiyu.comm.druid configuration initialization filter", e);
        }
    ...
    public ServletRegistrationBean<StatViewServlet> DruidStatViewServle2() {
        ...
        ServletRegistrationBean<StatViewServlet> servletRegistrationBean =
                new ServletRegistrationBean<StatViewServlet>(new StatViewServlet(), "/daiyu/comm/druid/*");
    ...
    public FilterRegistrationBean<WebStatFilter> druidStatFilter2() {
        ...
        // 添加不需要忽略的格式信息.
        filterRegistrationBean.addInitParameter("exclusions", "*.js,*.gif,*.jpg,*.png,*.css,*.ico,/daiyu.comm.druid/*");
